describe("Ext.mixin.Observable", function() {
    ...
    beforeEach(function() {
        ...
        // boss creation
        Boss = Ext.extend(Ext.mixin.Observable, {
        ...
        // employee creation
        Employee = Ext.extend(Ext.mixin.Observable, {
            constructor: function(conf) {
                conf = conf || {};
                this.listeners = conf.listeners;
    ...
    describe("firing events", function() {
        ...
        describe("return value", function(){
            ...
            beforeEach(function(){
                fn1Called = fn2Called = fn3Called = fn4Called = false;
                fn1 = function() { fn1Called = true; return true; };
                fn2 = function() { fn2Called = true; return true; };
                fn3 = function() { fn3Called = true; return true; };
                fn4 = function() { fn4Called = true; return false; };
            });
    ...
    describe("alias", function() {
        it("should alias addListener with on", function() {
            spyOn(Ext.mixin.Observable.prototype, 'addListener');

            Ext.mixin.Observable.prototype.on();

            expect(Ext.mixin.Observable.prototype.addListener).toHaveBeenCalled();
        });

        it("should alias removeListener with un", function() {
            spyOn(Ext.mixin.Observable.prototype, 'removeListener');

            Ext.mixin.Observable.prototype.un();

            expect(Ext.mixin.Observable.prototype.removeListener).toHaveBeenCalled();
        });

        it("should alias addManagedListener with mon", function() {
            spyOn(Ext.mixin.Observable.prototype, 'addManagedListener');

            Ext.mixin.Observable.prototype.mon();

            expect(Ext.mixin.Observable.prototype.addManagedListener).toHaveBeenCalled();
        });

        it("should alias removeManagedListener with mun", function() {
            spyOn(Ext.mixin.Observable.prototype, 'removeManagedListener');

            Ext.mixin.Observable.prototype.mun();

            expect(Ext.mixin.Observable.prototype.removeManagedListener).toHaveBeenCalled();
        });

        it("should alias observe with observeClass for retro compatibility", function() {
            expect(Ext.mixin.Observable.observeClass).toEqual(Ext.mixin.Observable.observe);
        });
    });
    ...
    describe("capture/release", function() {
        ...
        beforeEach(function() {
            ...
            Ext.mixin.Observable.capture(boss, capturer, fakeScope);
        });
        ...
        describe("release", function() {
            beforeEach(function() {
                Ext.mixin.Observable.releaseCapture(boss);
            });

            it("should restore the original fireEvent function", function() {
                expect(boss.fireEventArgs).toEqual(Ext.mixin.Observable.prototype.fireEventArgs);
            });
    ...
    describe("observe", function() {
        ...
        beforeEach(function() {
            ...
            Ext.mixin.Observable.observe(Boss, {
                fired: firedListener
            });
    ...
    describe("using mixin and extend in combination", function() {
        ...
        function declare (baseEntry, depth) {
            ...
            Ext.mixin.Observable.observe(entryE.T = spec.observable[entryE.name]);
            Ext.mixin.Observable.observe(entryM.T = spec.observable[entryM.name]);
        ...
        declare({ T: Ext.mixin.Observable, name: 'O', events: [] }, 5);

        it('should prepare all classes', function () {
            Ext.each(classes, function (entry) {
        ...
        it('should fire events on instances', function () {
            Ext.each(classes, function (entry) {
                Ext.each(entry.events, function (event) {
                    var T = entry.T,
                        calls = 0,
                        listeners = {},
                        fn = function () { ++calls; };
        ...
        it('should fire events to all bases', function () {
            Ext.each(classes, function (entry) {
                ...
                for (base = entry.base; base; base = base.base) {
                    Ext.each(base.events, function (event) {
                        var B = base.T,
                            calls = 0,
                            fn = function () { ++calls; };
    ...
    describe("destroy", function() {
        it("should hook the clearListeners method on destroy when used as a mixin", function() {
            ...
            spyOn(Ext.mixin.Observable.prototype, 'clearListeners').andCallThrough();

            foo.destroy();

            expect(Ext.mixin.Observable.prototype.clearListeners).toHaveBeenCalled();
        });
    });
});
