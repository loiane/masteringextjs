StartTest(function(t) {
    ...
    t.testExtJS({ 
        ...
        t.willFireNTimes(box, 'keydown', nbrKeys, 'TextField keydown');
        t.willFireNTimes(box, 'keyup', nbrKeys, 'TextField keyup');
        t.willFireNTimes(box, 'keypress', nbrKeys, 'TextField keypress');
