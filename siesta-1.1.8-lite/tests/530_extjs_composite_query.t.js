StartTest(function(outerT) {
    ...
    outerT.testExtJS(function (t) {
        ...
        t.is(t.normalizeElement('>>viewport'), viewport.getEl().dom, "viewport's element is found with >>");
        ...
        t.throwsOk(function () {
            t.compositeQuery('.panel[title=barbaz] => div.quix')
        ...
        t.type('viewport => .test-field input', 'Some text', function () {
            ...
            t.click('.panel[title=foo2] => button')
        })
    });    
});