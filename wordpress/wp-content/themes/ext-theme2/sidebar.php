<div id="sidebar">
	<div id="categoriesCont" style="display:none;">	
		<ul>
			<?php wp_list_cats('sort_column=name&optioncount=1&hierarchical=0'); ?>
		</ul>
	</div>
	<div id="archivesCont" style="display:none;">
		<ul class="list-archives">
			<?php wp_get_archives('type=monthly'); ?>
		</ul>
	</div>
	<div id="tagsCont" style="display:none;">
		  <?php 
			  $args = array(
			    'smallest'  => 8,
			    'largest'  => 16
	...
	<div id="recentCont" style="display:none;">
		<ul class="list-archives">
			<?php
	...
	<div id="booksCont" style="display:none;">
		<center>
